(function () {
      ...
      // iframe set height code
      sendHeight = function(){
      height = $('#contact-iframe').height()
      window.parent.postMessage({"height": height}, "*")
      }
      // iframe set height code end
  ...
  var contactFormUtils = {
    ...
    clearForm: function () {
      $('#feedbackForm .glyphicon').removeClass('glyphicon-check').css({color: ''});
  ...
  $(document).ready(function() {
    ...
    $('#feedbackForm input, #feedbackForm textarea').change(function () {
      ...
      if ($(this).val()) {
        ...
        checkBox.removeClass('glyphicon-check').addClass('').css({color: ''});
      }
    });
  });
})();
